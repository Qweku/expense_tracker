...
TextStyle headline2 = const TextStyle(fontSize: 25, color: Color.fromARGB(255, 194, 194, 194));
TextStyle bodyText1 = const TextStyle(fontSize: 14, color: Colors.black);
TextStyle bodyText2 = const TextStyle(fontSize: 14, color: Color.fromARGB(255, 194, 194, 194));
